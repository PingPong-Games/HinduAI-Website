  ...
  return (
    <div className="privacy-policy">
      <div className="privacy-content">
        ...
        <p>
          This privacy policy is applicable to the Hindu Assistant app (hereinafter referred to as "Application") 
          for mobile devices, which was developed by PingPongGames (hereinafter referred to as "Service Provider") 
        ...
        <section>
          ...
          <p>
            ...
            reasonable time thereafter. The Service Provider will retain Automatically Collected information for up 
            to 24 months and thereafter may store it in aggregate. If you'd like the Service Provider to delete User 
            Provided Data that you have provided via the Application, please contact them at{' '}
            <a href="mailto:pingponggamesstudio@gmail.com">pingponggamesstudio@gmail.com</a> and we will respond in 
            a reasonable time. Please note that some or all of the User Provided Data may be required in order for 
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:pingponggamesstudio@gmail.com">pingponggamesstudio@gmail.com</a>) so that they will be 
        ...
        <section>
          ...
          <p>
            ...
            information in order to operate, develop or improve their Application. Please be aware that, although we endeavor 
            provide reasonable security for information we process and maintain, no security system can prevent all potential 
            security breaches.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            as set forth in this Privacy Policy now and as amended by us. "Processing," means using cookies on a computer/hand 
            held device or using or touching information in any way, including, but not limited to, collecting, storing, deleting, 
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:pingponggamesstudio@gmail.com">pingponggamesstudio@gmail.com</a>.
          </p>
        </section>
